...
class TestPipelineStructure:
    ...
    def test_pipeline_has_expected_nodes(self):
        ...
        assert any("load" in name.lower() or "inspect" in name.lower() for name in node_names)
        assert any("language" in name.lower() or "programming" in name.lower() for name in node_names)
        assert any("salary" in name.lower() or "extract" in name.lower() for name in node_names)
...
class TestLoadAndInspectSurvey:
    ...
    def test_contains_expected_keys(self):
        ...
        expected_keys = {"total_filas", "total_columnas", "valores_nulos", "porcentaje_nulos", "mensaje"}
...
class TestAnalyzeProgrammingLanguages:
    ...
    def test_contains_expected_columns(self):
        ...
        expected_cols = {"columna", "respuestas_validas", "valores_unicos", "porcentaje_respuestas"}
...
class TestExtractSalaryData:
    ...
    def test_finds_salary_columns(self):
        ...
        assert "ConvertedComp" in result.columns or "ConvertedCompYearly" in result.columns
